...
namespace Leap.Unity {
  ...
  public static class Hotkeys {
		public static SelectionMode OnlyUserModifiable { get; private set; }
    ...
    public static void MakeGroup() {
      ...
      GameObject[] objs = Selection.GetFiltered<GameObject>(SelectionMode.ExcludePrefab | OnlyUserModifiable | SelectionMode.Editable);
      if (objs.Length == 0) {
        return;
      }
